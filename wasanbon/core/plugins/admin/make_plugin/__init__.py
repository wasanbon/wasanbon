...
class Plugin(PluginFunction):
    ...
    def __call__(self, argv):
        """ Make Current Package or Target Pakcage.
        $ wasanbon-admin.py make [PACK_NAME]
        """
        self.parser.add_option('-o', '--only', help='Build Only (Not Install) (default=False)', default=False, action='store_true', dest='only_flag')
        self.parser.add_option('-s', '--standalone', help='Installing RTC with standalone version (mostly YOUR_RTC_NAMEComp.exe',
                               action='store_true', default=False, dest='standalone_flag')
